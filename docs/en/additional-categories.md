...
### 2.	Data collected 
The data collected and used to calculate emissions for the additional categories relate to the number of staff and students at EPFL (via the **Headcount** module) plus other specific data described here:
