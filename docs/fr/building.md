...
L’empreinte carbone de chaque local 〖CF〗_room est calculée comme le produit de la surface du local en m2 et la consommation de chauffage, refroidissement, ventilation et éclairage en kWh par m2 par type de salle et par bâtiment ainsi que le facteur d’émission de l’électricité suisse tel que :

〖CF〗_room=Surface⋅(〖Cons〗_(heating,building,room_type )+〖Cons〗_(cooling,building,room_type )+〖Cons〗_(ventilation,builiding,room_type )+〖Cons〗_(lightning,building,room_type ) )⋅〖EF〗_electricity
Où : 
	building : bâtiment où les locaux de l’unité se situe
	room_type : type de local parmi les catégories bureau, divers, laboratoires, archives, bibliothèques et auditoires
	Surface: occupation en m2 
	〖Cons〗_(heating,building,room_type)
	〖Cons〗_(cooling,building,room_type)
	〖Cons〗_(ventilation,building,room_type)
	〖Cons〗_(lightning,building,room_type) : consommation électrique pour le chauffage, refroidissement, ventilation et éclairage du local en kWh/m2 extrapolée à partir des données de la VPO, selon les bâtiments et le type de salle
	〖EF〗_electricity: facteur d’émission pour la consommation d’électricité (0.097 kg CO2-eq/kWh (BAFU, 2025))

*Sous-module Émissions de combustion d’énergie*

L’empreinte carbone 〖CF〗_combustion est calculée comme le produit de la quantité de consommation de combustible en kg ou kWh ou kWh et le facteur d’émission correspondant tel que :

〖CF〗_combustion=Q_( fuel_type)⋅〖EF〗_(fuel_type)
Où : 
	...
	Q_(fuel_type): quantité de combustibles utilisée pour une source de chauffage non-centralisé en kg ou kWh saisie manuellement.
	〖EF〗_(fuel_type): facteur d’émission de chaque combustible en kg CO2-eq/kWh ou kg CO2-ep/kg.
...
- Le facteur d’émission 0.097 kg CO2-eq/kWh représente une moyenne annuelle suisse, et non du mix électrique au moment de l’utilisation de l’équipement.
...
- Norme SIA: https://www.bak.admin.ch/bak/fr/home/baukultur/qualitaet/normen/sia-normen.html
